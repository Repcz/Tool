...
📽️ 国际媒体 = select, 🇭🇰 香港节点, 🇺🇸 美国节点, 🇸🇬 狮城节点, 🇯🇵 日本节点, 🇨🇳 台湾节点, 🚀 手动切换,  DIRECT, no-alert=0, hidden=0

📽️ Emby = select, 🇭🇰 香港节点, 🇺🇸 美国节点, 🇸🇬 狮城节点, 🇯🇵 日本节点, 🇨🇳 台湾节点,  DIRECT, no-alert=0, hidden=0, include-other-group = "🚀 手动切换"

🖥️ 微软服务 = select, 🇭🇰 香港节点, 🇺🇸 美国节点, 🇸🇬 狮城节点, 🇯🇵 日本节点, 🇨🇳 台湾节点, 🚀 手动切换,  DIRECT, no-alert=0, hidden=0
...
🐟 兜底分流 = select, 🇭🇰 香港节点, 🇺🇸 美国节点, 🇸🇬 狮城节点, 🇯🇵 日本节点, 🇨🇳 台湾节点, 🚀 手动切换,  no-alert=0, hidden=0
